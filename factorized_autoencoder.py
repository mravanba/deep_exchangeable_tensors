...
def main(opts):
    ...
    data = get_data('movielens-100k', train=.8, valid=.2, test=.001)#currently not reading the standard train-test partitioning of movielense-100. Randomly partitioning. fix me!
    ...
    with tf.Graph().as_default():
        ...
        iters_per_epoch = N*M//(maxN * maxM)# a bad heuristic: the whole matrix is in expectation covered in each epoch
