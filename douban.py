...
def load_data(p_validation = 0.07):
    ...
    douban = {}
    douban["mat_values_all"] = ratings
    douban["mat_values_tr"] = ratings[mask_tr_val_split == 0]
    douban["mat_values_val"] = ratings[mask_tr_val_split == 1]
    douban["mat_values_test"] = ratings[mask_tr_val_split == 2]
    douban["mat_values_tr_val"] = ratings[mask_tr_val_split <= 1]

    douban["mask_indices_all"] = index
    douban["mask_indices_tr"] = index[mask_tr_val_split == 0, :]
    douban["mask_indices_val"] = index[mask_tr_val_split == 1, :]
    douban["mask_indices_test"] = index[mask_tr_val_split == 2, :]
    douban["mask_indices_tr_val"] = index[mask_tr_val_split <= 1, :]

    douban["mask_tr_val_split"] = mask_tr_val_split

    n, m = index.max(axis=0) + 1
    douban['mat_shape'] = (n, m, 5)
    return douban
