...
def get_data(dataset='movielens-small',
    ...
    if 'movielens-small' in dataset:
        ...
        mat_values_ts = dense_array_to_sparse_values(mat[:,:,None], mask_indices_ts)
        ...
        #         'mask_indices_val':mask_indices_val, 
        #         'mat_shape':[n_users, n_movies, 1], 
        #         'mask_split_tr_val':split_tr_val}
        ...
        split = np.random.choice([0,1], size=(n_ratings - len(ratings_ts)), p=(p_tr, p_val))

        ratings_tr = ratings_tr_val[split==0]
        ratings_val = ratings_tr_val[split==1]
